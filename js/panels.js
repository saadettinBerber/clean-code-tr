...
const Panels = (function () {
  ...
  function gapRow(toc, chapter, pages) {
    ...
    return `<div class="toc-gap"><span class="en-text">Not translated yet from page ${next} — type "/cevir ${next}"</span>` +
      `<span class="tr-text">Sayfa ${next} ve sonrası henüz çevrilmedi — "/cevir ${next}" yazın</span></div>`;
  }
