...
- Örnek: "Tek Sorumluluk İlkesi (Single Responsibility Principle)"
...
- Kütüphane ve framework adları (JUnit, Spring, vb.)
- Yaygın kısaltmalar: API, HTTP, SQL, OOP, TDD, IDE, GUI, CLI
- Git terimleri: commit, push, pull, merge, branch
- "Clean Code", "Agile" gibi kitap/hareket adları (ancak yanlarında Türkçe açıklama olabilir)
...
- Robert C. Martin'in samimi, deneyim paylaşan üslubunu yansıt
