window.PAGE({
  ...
  "concepts": [
    ...
    },
    {
      ...
      "body_html": "<h4><span class=\"tr-text\">Kavram Açıklaması</span><span class=\"en-text\" style=\"display:none;\">Concept Explanation</span></h4>\n<p><span class=\"tr-text\">Tek Sorumluluk İlkesi (SRP - Single Responsibility Principle), sınıfların ve fonksiyonların yalnızca bir değişim nedenine sahip olması gerektiğini söyler. Fonksiyonlar bağlamında bu, fonksiyonun sadece bir şey yapması gerektiği anlamına gelir. Eğer bir fonksiyonu değiştirmek için birden fazla sebepiniz varsa, fonksiyonunuz muhtemelen birden fazla sorumluluk taşıyordur.</span><span class=\"en-text\" style=\"display:none;\">The Single Responsibility Principle (SRP) states that classes and functions should have only one reason to change. In the context of functions, this means a function should only do one thing. If you have multiple reasons to change a function, it probably carries multiple responsibilities.</span></p>\n<h4><span class=\"tr-text\">SRP İhlali Belirtileri</span><span class=\"en-text\" style=\"display:none;\">Signs of SRP Violation</span></h4>\n<ul style=\"margin-left: 20px; line-height: 1.8;\">\n<li><span class=\"tr-text\">Fonksiyon ismindeki \"and\"/\"or\" kelimeleri</span><span class=\"en-text\" style=\"display:none;\">\"and\"/\"or\" in function name</span></li>\n<li><span class=\"tr-text\">Birden fazla seviye soyutlama</span><span class=\"en-text\" style=\"display:none;\">Multiple levels of abstraction</span></li>\n<li><span class=\"tr-text\">3'ten fazla parametre</span><span class=\"en-text\" style=\"display:none;\">More than 3 parameters</span></li>\n<li><span class=\"tr-text\">Test yazarken birden fazla test case</span><span class=\"en-text\" style=\"display:none;\">Multiple test cases when writing tests</span></li>\n</ul>\n<div class=\"tip\"><strong><span class=\"tr-text\">Pratik İpucu</span><span class=\"en-text\" style=\"display:none;\">Practical Tip</span></strong><span class=\"tr-text\">\"Değişim\" kelimesini düşünün: Bu fonksiyon hangi nedenle değişir? Sadece bir cevap varsa, SRP'ye uyuyordur.</span><span class=\"en-text\" style=\"display:none;\">Think about \"change\": For what reason would this function change? If there's only one answer, you're following SRP.</span></div>"
    }
  ]
});
