window.PAGE({
  ...
  "concepts": [
    ...
    },
    {
      ...
      "body_html": "<h4><span class=\"tr-text\">Kavram Açıklaması</span><span class=\"en-text\">Concept Explanation</span></h4>\n<p><span class=\"tr-text\">Programlama sosyal bir aktivitedir. Kod hakkında konuşurken, değişken ve fonksiyon isimlerini sesli olarak söyleyebilmeniz gerekir. Beynimizin büyük bir bölümü konuşma dilini işlemeye adanmıştır — telaffuz edilemeyen isimler kullanmak bu kapasiteyi boşa harcamaktır. <code>genymdhms</code> gibi kısaltmalar ekip içinde iletişimi imkânsız hale getirir.</span><span class=\"en-text\">Programming is a social activity. When discussing code, you need to be able to say variable and function names out loud. A huge part of our brains is dedicated to processing spoken language — using unpronounceable names wastes that capacity. Abbreviations like <code>genymdhms</code> make team communication impossible.</span></p>\n<h4><span class=\"tr-text\">Kötü Örnek (Before)</span><span class=\"en-text\">Bad Example (Before)</span></h4>\n<span class=\"label-bad\"><span class=\"tr-text\">KÖTÜ — Telaffuz edilemeyen kısaltmalar</span><span class=\"en-text\">BAD — Unpronounceable abbreviations</span></span>\n<pre>class MktgCmpgn {\n    private String cmpgnNm;\n    private Date strtDt;\n    private Date endDt;\n    private int tgtAudSz;\n    private double bdgtAmt;\n\n    public double calcROI(double rvn) {\n        return (rvn - bdgtAmt) / bdgtAmt;\n    }\n}</pre>\n<div class=\"explanation\"><span class=\"tr-text\">\"Hey, em-kay-tee-jee-see-em-pee-jee-en'daki see-em-pee-jee-en-en-em'i kontrol eder misin?\" — Ekip toplantısında bu isimleri konuşmak imkânsızdır. Her kısaltma bir bulmaca haline gelir.</span><span class=\"en-text\">\"Hey, can you check the see-em-pee-jee-en-en-em in the em-kay-tee-jee-see-em-pee-jee-en?\" — It's impossible to discuss these names in a team meeting. Every abbreviation becomes a puzzle.</span></div>\n<h4><span class=\"tr-text\">İyi Örnek (After)</span><span class=\"en-text\">Good Example (After)</span></h4>\n<span class=\"label-good\"><span class=\"tr-text\">İYİ — Doğal dilde konuşulabilir isimler</span><span class=\"en-text\">GOOD — Names you can say in natural language</span></span>\n<pre>class MarketingCampaign {\n    private String campaignName;\n    private Date startDate;\n    private Date endDate;\n    private int targetAudienceSize;\n    private double budgetAmount;\n\n    public double calculateROI(double revenue) {\n        return (revenue - budgetAmount) / budgetAmount;\n    }\n}</pre>\n<div class=\"tip\"><strong><span class=\"tr-text\">Pratik İpucu</span><span class=\"en-text\">Practical Tip</span></strong><span class=\"tr-text\">Basit bir test: yazdığınız ismi bir iş arkadaşınıza sesli olarak söylemeyi hayal edin. \"Marketing campaign'daki campaign name'i güncelledim\" doğal gelir. \"Em-kay-tee-jee'deki see-em-pee-jee-en-en-em'i güncelledim\" diye kimse konuşmak istemez. Eğer ismi sesli okuyamıyorsanız, yeniden adlandırın.</span><span class=\"en-text\">Simple test: imagine saying the name out loud to a colleague. \"I updated the campaign name in marketing campaign\" sounds natural. Nobody wants to say \"I updated the see-em-pee-jee-en-en-em in em-kay-tee-jee.\" If you can't read the name aloud, rename it.</span></div>"
    }
  ]
});
