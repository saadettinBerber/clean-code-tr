  ...
  "concepts": [
    {
      ...
      "body_html": "<h4><span class=\"tr-text\">Kavram Açıklaması</span><span class=\"en-text\" style=\"display:none;\">Concept Explanation</span></h4>\n<p><span class=\"tr-text\">Bir ismin zaten içinde bulunduğu sınıf veya paket tarafından sağlanan bağlamı isme tekrar eklemek gereksizdir. Bu sadece isimleri uzatır ve okunabilirliği azaltır. Özellikle proje kısaltmalarını her sınıfın başına eklemek, IDE'lerin otomatik kod tamamlama özelliklerini kullanışsız hale getirir.</span><span class=\"en-text\" style=\"display:none;\">It is unnecessary to add context to a name that is already provided by the class or package it resides in. This only lengthens names and reduces readability. Especially adding project abbreviations to the beginning of every class makes the IDE's autocomplete features useless.</span></p>\n<h4><span class=\"tr-text\">Kötü Örnek (Before)</span><span class=\"en-text\" style=\"display:none;\">Bad Example (Before)</span></h4>\n<span class=\"label-bad\"><span class=\"tr-text\">KÖTÜ — Gereksiz önekler</span><span class=\"en-text\" style=\"display:none;\">BAD — Gratuitous prefixes</span></span>\n<pre>// Proje adı: Mail System (MS)\npublic class MSUser {\n    private String msUserEmail;\n    private String msUserPassword;\n}</pre>\n<div class=\"explanation\"><span class=\"tr-text\">Burada hem sınıfın hem de değişkenlerin başındaki <code>MS</code> öneki hiçbir değer katmaz. Zaten Mail System projesinde çalıştığımızı biliyoruz.</span><span class=\"en-text\" style=\"display:none;\">Here, the <code>MS</code> prefix at the beginning of both the class and variables adds no value. We already know we are working on the Mail System project.</span></div>\n<h4><span class=\"tr-text\">İyi Örnek (After)</span><span class=\"en-text\" style=\"display:none;\">Good Example (After)</span></h4>\n<span class=\"label-good\"><span class=\"tr-text\">İYİ — Kısa ve öz isimler</span><span class=\"en-text\" style=\"display:none;\">GOOD — Concise names</span></span>\n<pre>public class User {\n    private String email;\n    private String password;\n}</pre>\n<div class=\"tip\"><strong><span class=\"tr-text\">Pratik İpucu</span><span class=\"en-text\" style=\"display:none;\">Practical Tip</span></strong><span class=\"tr-text\">Kısa isimler genellikle uzun isimlerden daha iyidir, ancak sadece yeterli bağlam sağlandığında. Gereksiz bağlam eklemek yerine, ismin bulunduğu sınıfın veya modülün bu bağlamı sağlayıp sağlamadığını kontrol edin.</span><span class=\"en-text\" style=\"display:none;\">Shorter names are generally better than longer ones, but only when sufficient context is provided. Instead of adding gratuitous context, check if the class or module containing the name provides that context.</span></div>"
    },
    {
      "id": "guess-stats",
      "title": {
      ...
      "body_html": "<h4><span class=\"tr-text\">Kavram Açıklaması</span><span class=\"en-text\" style=\"display:none;\">Concept Explanation</span></h4>\n<p><span class=\"tr-text\">Listing 2-2'deki <code>GuessStatisticsMessage</code> sınıfı, bir mesajın parçalarını (sayı, fiil, ek) nasıl bir araya getireceğini bilir. Değişkenler (number, verb, pluralModifier) sınıf düzeyinde tanımlanarak net bir bağlam kazanmıştır.</span><span class=\"en-text\" style=\"display:none;\">The <code>GuessStatisticsMessage</code> class in Listing 2-2 knows how to put together the parts of a message (number, verb, suffix). The variables (number, verb, pluralModifier) have gained clear context by being defined at the class level.</span></p>\n<div class=\"explanation\"><span class=\"tr-text\">Bu tasarımda, her bir durum (hiç yok, bir tane, çok tane) ayrı metotlara bölünerek kodun okunabilirliği artırılmıştır. Değişkenlerin neyi temsil ettiği, sınıfın adından ve kullanım yerinden açıkça anlaşılmaktadır.</span><span class=\"en-text\" style=\"display:none;\">In this design, readability is improved by splitting each case (none, one, many) into separate methods. What the variables represent is clearly understood from the class name and where they are used.</span></div>\n<div class=\"tip\"><strong><span class=\"tr-text\">Öğrenilen Ders</span><span class=\"en-text\" style=\"display:none;\">Lesson Learned</span></strong><span class=\"tr-text\">Eğer bir grup değişken sürekli birlikte kullanılıyorsa ve bir bağlama ihtiyaç duyuyorsa, bu değişkenleri bir sınıf içinde toplamak (encapsulation) en temiz çözümdür.</span><span class=\"en-text\" style=\"display:none;\">If a group of variables is constantly used together and needs context, gathering them inside a class (encapsulation) is the cleanest solution.</span></div>"
    }
  ]
});
