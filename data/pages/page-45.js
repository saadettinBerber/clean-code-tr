window.PAGE({
  ...
  "concepts": [
    ...
    },
    {
      ...
      "body_html": "<h4><span class=\"tr-text\">Kavram Açıklaması</span><span class=\"en-text\" style=\"display:none;\">Concept Explanation</span></h4>\n<p><span class=\"tr-text\">Bilişsel kesinti, bir kod satırını anlamak için okuyucunun başka bir yere bakması gerektiğinde oluşan akış bozulmasıdır. Fonksiyon imzalarını kontrol etmeye zorlamak, belgelere başvurmak veya başka dosyalara atlamak gibi durumlar bilişsel kesintilere neden olur.</span><span class=\"en-text\" style=\"display:none;\">A cognitive break occurs when understanding a line of code requires the reader to look elsewhere. Checking function signatures, consulting documentation, or jumping to other files all cause cognitive breaks.</span></p>\n<h4><span class=\"tr-text\">Kötü Örnek (Before)</span><span class=\"en-text\" style=\"display:none;\">Bad Example (Before)</span></h4>\n<span class=\"label-bad\"><span class=\"tr-text\">KÖTÜ — Anlam için imza gerekli</span><span class=\"en-text\" style=\"display:none;\">BAD — Signature needed for meaning</span></span>\n<pre><span class=\"comment\">// Bu ne yapıyor? Belgeyi mi formatlar, formatı mı belgeler?</span>\n<span class=\"method\">format</span>(document);\n\n<span class=\"comment\">// Diske mi yazıyor, listeye mi ekliyor?</span>\n<span class=\"method\">save</span>(users, file);\n\n<span class=\"comment\">// Sonucu döndürür mü, yerinde mi değiştirir?</span>\n<span class=\"method\">sort</span>(data);</pre>\n<h4><span class=\"tr-text\">İyi Örnek (After)</span><span class=\"en-text\" style=\"display:none;\">Good Example (After)</span></h4>\n<span class=\"label-good\"><span class=\"tr-text\">İYİ — İmza gerektirmeyen açıklık</span><span class=\"en-text\" style=\"display:none;\">GOOD — Self-evident without signatures</span></span>\n<pre>document.<span class=\"method\">formatAsMarkdown</span>();\n\n<span class=\"method\">saveUsersToFile</span>(users, filePath);\n\n<span class=\"kw\">const</span> sortedData = <span class=\"method\">sortByDate</span>(data);</pre>\n<div class=\"tip\"><strong><span class=\"tr-text\">Pratik İpucu</span><span class=\"en-text\" style=\"display:none;\">Practical Tip</span></strong><span class=\"tr-text\">Kodunuzu okuyucunun gözüyle inceleyin. Eğer bir satırı anlamak için başka bir yere bakmanız gerekiyorsa, isim seçimi veya yapı yeterince açık değildir. Amacınız \"sıfır atlama\" (zero-jump) okunabilirlik olmalıdır.</span><span class=\"en-text\" style=\"display:none;\">Review your code through the reader's eyes. If understanding a line requires looking elsewhere, the naming or structure isn't clear enough. Aim for \"zero-jump\" readability.</span></div>"
    }
  ]
});
