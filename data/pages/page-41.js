window.PAGE({
  ...
  "concepts": [
    ...
    },
    {
      ...
      "body_html": "<h4><span class=\"tr-text\">Kavram Açıklaması</span><span class=\"en-text\" style=\"display:none;\">Concept Explanation</span></h4>\n<p><span class=\"tr-text\">Olay (event) formu, girdi argümanı olan ama çıktı döndürmeyen tekli fonksiyon formudur. Sistem durumunu değiştirmek için kullanılır. Fonksiyon adı, bunun bir olay olduğunu açıkça belirtmelidir.</span><span class=\"en-text\" style=\"display:none;\">The event form is a monadic function form that has an input argument but returns no output. It's used to alter system state. The function name must clearly indicate that this is an event.</span></p>\n<h4><span class=\"tr-text\">Kötü Örnek (Before)</span><span class=\"en-text\" style=\"display:none;\">Bad Example (Before)</span></h4>\n<span class=\"label-bad\"><span class=\"tr-text\">KÖTÜ — Belirsiz olay ismi</span><span class=\"en-text\" style=\"display:none;\">BAD — Unclear event name</span></span>\n<pre><span class=\"kw\">void</span> <span class=\"method\">handle</span>(<span class=\"type\">int</span> code) {\n    <span class=\"comment\">// Ne olayı? Belirsiz!</span>\n    <span class=\"kw\">if</span> (code &gt; <span class=\"field\">3</span>) {\n        lockAccount();\n    }\n}</pre>\n<h4><span class=\"tr-text\">İyi Örnek (After)</span><span class=\"en-text\" style=\"display:none;\">Good Example (After)</span></h4>\n<span class=\"label-good\"><span class=\"tr-text\">İYİ — Açık olay ismi</span><span class=\"en-text\" style=\"display:none;\">GOOD — Clear event name</span></span>\n<pre><span class=\"kw\">void</span> <span class=\"method\">onLoginAttemptFailed</span>(<span class=\"type\">int</span> failedAttemptCount) {\n    <span class=\"kw\">if</span> (failedAttemptCount &gt; MAX_ALLOWED_ATTEMPTS) {\n        lockAccount();\n        notifySecurityTeam();\n    }\n}</pre>\n<div class=\"tip\"><strong><span class=\"tr-text\">Pratik İpucu</span><span class=\"en-text\" style=\"display:none;\">Practical Tip</span></strong><span class=\"tr-text\">Olay fonksiyonları için \"on\" veya \"when\" ön ekini kullanın: <code class=\"inline\">onPaymentReceived</code>, <code class=\"inline\">whenSessionExpired</code>. Bu, okuyucuya yan etkinin kasıtlı olduğunu bildirir.</span><span class=\"en-text\" style=\"display:none;\">Use \"on\" or \"when\" prefixes for event functions: <code class=\"inline\">onPaymentReceived</code>, <code class=\"inline\">whenSessionExpired</code>. This tells the reader the side effect is intentional.</span></div>"
    },
    {
