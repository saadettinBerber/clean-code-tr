window.PAGE({
  ...
  "concepts": [
    ...
    },
    {
      ...
      "body_html": "<h4><span class=\"tr-text\">Kavram Açıklaması</span><span class=\"en-text\">Concept Explanation</span></h4>\n<p><span class=\"tr-text\">Macar Notasyonu, değişken isimlerinin başına veri türünü belirten kısaltmalar ekleme geleneğidir. 1980'lerde, derleyicilerin tür kontrolü yapmadığı ve IDE'lerin yetersiz olduğu dönemlerde Windows programcıları için hayati önem taşıyordu. Ancak günümüzde modern dillerin güçlü tür sistemleri ve akıllı IDE'leri bu notasyonu tamamen gereksiz ve okunabilirliği bozan bir yük haline getirmiştir.</span><span class=\"en-text\">Hungarian Notation is the convention of adding abbreviations indicating the data type to the beginning of variable names. In the 1980s, when compilers didn't check types and IDEs were inadequate, it was vital for Windows programmers. Today, however, strong type systems and smart IDEs of modern languages have made this notation completely redundant and a burden that hampers readability.</span></p>\n<h4><span class=\"tr-text\">Tarihsel Örnek (C++)</span><span class=\"en-text\">Historical Example (C++)</span></h4>\n<span class=\"label-bad\"><span class=\"tr-text\">ESKİ TARZ — Macar Notasyonu</span><span class=\"en-text\">OLD STYLE — Hungarian Notation</span></span>\n<pre>char* lpszName; // Long Pointer to String Zero-terminated\nint iCount;     // Integer\nbool bIsEnabled; // Boolean</pre>\n<div class=\"explanation\"><span class=\"tr-text\">Bu isimler o zamanlar türü hatırlamak için bir \\\"koltuk değneği\\\" görevi görüyordu. Günümüzde ise sadece kafa karıştırır.</span><span class=\"en-text\">Back then, these names served as a \\\"crutch\\\" to remember the type. Today, they only cause confusion.</span></div>\n<h4><span class=\"tr-text\">Modern Yaklaşım</span><span class=\"en-text\">Modern Approach</span></h4>\n<span class=\"label-good\"><span class=\"tr-text\">MODERN — Temiz ve Türden Bağımsız</span><span class=\"en-text\">MODERN — Clean and Type-Independent</span></span>\n<pre>String name;\nint count;\nboolean isEnabled;</pre>\n<div class=\"tip\"><strong><span class=\"tr-text\">Pratik İpucu</span><span class=\"en-text\">Practical Tip</span></strong><span class=\"tr-text\">Eğer kodunuzda bir değişkenin türünü isminden okumaya ihtiyaç duyuyorsanız, ya fonksiyonunuz çok uzundur ya da sınıfınız çok karmaşıktır. İsimleri türden değil, niyetten türetin.</span><span class=\"en-text\">If you need to read the type of a variable from its name, either your function is too long or your class is too complex. Derive names from intent, not from type.</span></div>"
    }
  ]
});
