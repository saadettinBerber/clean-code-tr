window.PAGE({
  ...
  "concepts": [
    ...
    },
    {
      ...
      "body_html": "<h4><span class=\"tr-text\">Kavram Açıklaması</span><span class=\"en-text\">Concept Explanation</span></h4>\n<p><span class=\"tr-text\">Fonksiyon uzunluğu hakkında kesin bir kural olmamakla birlikte, deneyimli yazılımcılar şu prensiplere dikkat eder: 1980'lerde standart bir ekran 24 satırdı. Günümüzde ise fonksiyonlar 20 satırı geçmemelidir. Metot (method) başına ortalama 5-10 satır idealdir. Kodunuz ne kadar küçükse, hata yapma olasılığınız o kadar düşüktür.</span><span class=\"en-text\">While there's no hard rule about function length, experienced programmers follow these principles: In the 1980s, a standard screen was 24 lines. Today, functions should not exceed 20 lines. 5-10 lines per method is ideal. The smaller your code, the lower your chance of errors.</span></p>\n<h4><span class=\"tr-text\">Kötü Örnek (Before)</span><span class=\"en-text\">Bad Example (Before)</span></h4>\n<span class=\"label-bad\"><span class=\"tr-text\">KÖTÜ — 150 satırlık dev fonksiyon</span><span class=\"en-text\">BAD — 150-line giant function</span></span>\n<pre>function handleUserRegistration(data) {\n    // 150 satırlık dev fonksiyon...\n    // Validasyon, veritabanı işlemleri, email gönderimi,\n    // raporlama, loglama hepsi tek yerde\n}</pre>\n<h4><span class=\"tr-text\">İyi Örnek (After)</span><span class=\"en-text\">Good Example (After)</span></h4>\n<span class=\"label-good\"><span class=\"tr-text\">İYİ — 5-10 satırlık küçük fonksiyonlar</span><span class=\"en-text\">GOOD — 5-10 line small functions</span></span>\n<pre>function registerUser(data) {\n    validateInput(data);\n    user = createUser(data);\n    sendWelcomeEmail(user);\n    logRegistration(user);\n    return user;\n}</pre>\n<div class=\"tip\"><strong><span class=\"tr-text\">Pratik İpucu</span><span class=\"en-text\">Practical Tip</span></strong><span class=\"tr-text\">Ekrana sığdırmak yerine, fonksiyonun tek bir iş yaptığını düşünün. Eğer fonksiyonu \"ve\" kelimesiyle anlatabiliyorsanız, bölme zamanı gelmiştir.</span><span class=\"en-text\">Think about whether the function does one thing, not whether it fits on screen. If you can describe it with \"and,\" it's time to split.</span></div>"
    },
    {
