...
## 8. AGENTS.md'yi Güncelle

- `last_translated_page` değerini yeni çevrilen sayfa numarasıyla güncelle.
- Dosyadaki `last_translated_page: X` satırını `last_translated_page: Y` olarak değiştir.
- Aynı güncellemeyi `CLAUDE.md`'de de yap (her iki dosya senkronize tutulur).
